...
<Callout title="Plugin Required" type="warn">Before using `createWorkspace`, you need to install the required plugins.</Callout>
...
The Workspace provides several APIs to help you manage files. For more details, visit the [File System](/docs/file-system) documentation.
