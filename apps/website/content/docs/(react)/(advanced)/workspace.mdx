...
See this [documentation](/docs/functions/create-workspace) to know more details.
...
For more details, visit the [File System](/docs/file-system) and [Workspace API reference](/docs/functions/workspace#methods) documentation.
