...
Monaco has an extensive configuration system. Codespark supports passing through all Monaco configuration options to customize your editor. Check the [API reference](/docs/components/codespark-editor#options) for more detail.
