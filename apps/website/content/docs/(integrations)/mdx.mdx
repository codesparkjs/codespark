...
Codespark provides a remark plugin to extend MDX capabilities, enabling you to render Codespark components through code block directives in Markdown files.
...
| Directive | Example | Rendered Component |
| --- | --- | --- |
...
Code block directives support passing string-type props to the corresponding components, such as `height` and `width`. For more details, see the [API reference](/).
