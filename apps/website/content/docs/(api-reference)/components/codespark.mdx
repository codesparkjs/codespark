...
该属性会直接透传给 `CodesparkPreview` 组件，具体用法请查看[CodesparkPreview > Props > tailwindcss](/docs/components/codespark-preview#tailwindcss)。
...
该属性会直接透传给 `CodesparkEditor` 组件，具体用法请查看[CodesparkEditor > Props > toolbox](/docs/components/codespark-editor#toolbox)。
...
该属性会直接透传给 `CodesparkPreview` 组件，具体用法请查看[CodesparkPreview > Props > children](/docs/components/codespark-preview#children)。
...
该属性会直接透传给 `CodesparkPreview` 组件，具体用法请查看[CodesparkPreview > Props > onConsole](/docs/components/codespark-preview#onconsole)。
...
该属性会直接透传给 `CodesparkPreview` 组件，具体用法请查看[CodesparkPreview > Props > onError](/docs/components/codespark-preview#onerror)。
