...
export default function App() {
  return (
    <div className="flex items-center gap-8 rounded-2xl p-7 shadow-lg">
      <div>
        <img className="size-48 rounded-md shadow-xl" alt="" src="https://tailwindcss.com/_next/static/media/cover.f75d494c.png" />
      </div>
