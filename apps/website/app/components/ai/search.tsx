...
export function AISearchInput(props: ComponentProps<'form'>) {
  ...
  return (
    <form {...props} className={cn('flex items-start pe-2 outline-none', props.className)} onSubmit={onStart}>
      <Input
        value={input}
...
const roleName: Record<string, string> = {
  user: 'You',
  assistant: 'Codespark AI Assistant'
};
...
export function AISearchPanel() {
  ...
  return (
    <Drawer open={open} onOpenChange={setOpen} direction="right">
      <DrawerContent className="bg-fd-card text-fd-card-foreground flex h-dvh flex-col rounded-l-lg p-3 outline-none">
        <AISearchPanelHeader />
